...
class Charge(Base):
    ...
    gateway_status: Mapped[str | None] = mapped_column(String(80))
    checkout_url: Mapped[str | None] = mapped_column(String(500))
    bank_slip_url: Mapped[str | None] = mapped_column(String(500))
    pix_qr_code_payload: Mapped[str | None] = mapped_column(Text)
    pix_qr_code_image: Mapped[str | None] = mapped_column(Text)
